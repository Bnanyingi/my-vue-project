...
const filteredCustomers = computed(() => {
  return customers.filter((customer) => {
    ...
    const salesRepFilterValue =
      salesRepFilter.value === "" || customer.salesRep === salesRepFilter.value;
  ...
  <div class="p-4">
    ...
    <div class="flex flex-wrap items-center justify-between mb-4">
      <div class="flex items-center mb-2 filters md:mb-0">
        ...
        <select v-model="salesRepFilter" class="p-2 bg-gray-100 rounded-lg">
          <option value="">All</option>
          <option v-for="rep in salesReps" :value="rep" :key="rep">
            {{ rep }}
          </option>
        </select>
      </div>
      <div class="flex items-center search">
        ...
        <input
          ...
          class="p-2 bg-gray-100 rounded-lg form-control"
        />
      </div>
    </div>
    <div>
      <table
        class="w-full mb-4 border border-collapse border-gray-300"
        id="customerTable"
      >
        <thead>
        ...
        <tbody>
          ...
          >
            ...
            <td class="p-2">
              ...
              <EditCustomerModal
                v-if="editCustomerModalVisible"
                :customer="selectedCustomer"
                @close="editCustomerModalVisible = false"
      ...
      <div class="flex justify-center">
        <Pagination
          v-if="filteredCustomers.length > perPage"
          v-model="currentPage"
          :pages="pages"
          :range-size="1"
    ...
    <div>
      <button
        ...
        class="px-2 py-1 text-white bg-green-500 rounded hover:bg-green-700"
      >
        Add Customer
      </button>
      <AddCustomerModal
